...
o_draw.text((100, 130), "- Home.md", font=font_tree, fill=(160, 160, 175, 255))
o_draw.text((100, 150), "- Announcements.md", font=font_tree, fill=(160, 160, 175, 255))
o_draw.text((100, 170), "- Tasks.md", font=font_tree, fill=(160, 160, 175, 255))
o_draw.text((100, 190), "- Grades.md", font=font_tree, fill=(160, 160, 175, 255))
o_draw.text((100, 210), "- Discussions.md", font=font_tree, fill=(160, 160, 175, 255))
o_draw.text((100, 230), "- Calendar.md", font=font_tree, fill=(160, 160, 175, 255))
o_draw.text((100, 255), "> Modules", font=font_tree, fill=(160, 160, 175, 255))
o_draw.text((100, 280), "> Files", font=font_tree, fill=(160, 160, 175, 255))
o_draw.text((80, 310), "> CS-350 - Software Arch", font=font_tree, fill=(180, 180, 195, 255))
...
n_draw.text((35, 75), "v CS-101 - Intro to CS", font=font_tree_b, fill=(220, 220, 230, 255))
n_draw.text((50, 100), "- Course.md", font=font_tree, fill=(160, 160, 175, 255))
n_draw.text((50, 122), "- Home.md", font=font_tree, fill=(160, 160, 175, 255))
n_draw.text((50, 144), "- Announcements.md", font=font_tree, fill=(160, 160, 175, 255))
n_draw.rounded_rectangle([(45, 164), (230, 188)], radius=4, fill=(124, 58, 237, 60))
n_draw.text((50, 167), "- Grades.md", font=font_tree_b, fill=(167, 139, 250, 255))
n_draw.text((50, 192), "- Tasks.md", font=font_tree, fill=(160, 160, 175, 255))
n_draw.text((50, 214), "- Discussions.md", font=font_tree, fill=(160, 160, 175, 255))
n_draw.text((50, 236), "- Calendar.md", font=font_tree, fill=(160, 160, 175, 255))
n_draw.text((50, 260), "> Modules", font=font_tree, fill=(160, 160, 175, 255))
n_draw.text((50, 285), "> Files", font=font_tree, fill=(160, 160, 175, 255))
