/**
 * @module api/canvas-client
 * @description Core Canvas LMS REST API client handling authentication, pagination,
 * and data extraction for courses, modules, assignments, discussions, announcements,
...
export class CanvasApiClient {
  ...
  public async probeCourseCapabilities(courseId: string | number): Promise<CourseCapabilityReport> {
    return await probeCourseEndpoints(this.baseUrl, this.apiToken, courseId);
  }
